-- Migration: Fix RLS Infinite Recursion on expenses and expense_splits
-- Problem: Circular RLS evaluation between expenses SELECT and expense_splits SELECT (error 42P17)
-- Solution: Narrowly scoped SECURITY DEFINER helper functions that bypass RLS during authorization checks.
